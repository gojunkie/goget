...
// Error return from Downloader
var (
	ErrChunkDownloadNotSupport = errors.New("Chunk download not support")
)

// FileInfo represent chunk file's info
...
// Downloader defined a public API
type Downloader interface {
	Download(fileURL, filename string) (<-chan FileInfo, error)
}

// New downloader factory function
